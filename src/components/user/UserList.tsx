...
export default function RecentUserList() {
      ...
      <div className=''>
        ...
        <div className='mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-6 py-2.5'>
          ...
          <div className='relative w-full sm:w-80 '>
            ...
            <Input
              ...
              className='pl-10 border border-[#66F1FC]'
            />
          </div>
        </div>

        {/* Desktop Table */}
        <div className='hidden overflow-hidden rounded-lg bg-[#1F2937] shadow-sm md:block'>
          <div className='overflow-x-auto'>
            <table className='w-full'>
              <thead className='bg-[#66F1FC] text-white'>
                <tr>
                  <th className='px-6 py-4 text-left text-base text-[#1B6469] font-medium'>
                    SL no.
                  </th>
                  <th className='px-6 py-4 text-left text-base text-[#1B6469] font-medium'>
                    Subscriber Name
            ...
            >
              ...
              <div className='space-y-2'>
                <div>
                  ...
                  <p className='text-sm text-[#F3F4F6]'>{subscriber.name}</p>
                </div>
                <div>
                  <span className='text-xs font-medium text-gray-500'>
                    Email:
                  </span>
                  <p className='text-sm text-[#F3F4F6]'>{subscriber.email}</p>
                </div>
              ...
              <div key={index}>
                {page === "..." ? (
                  ...
                  <Button
                    ...
                    className={`h-8 w-8 p-0 ${
                      currentPage === page
                    ? "bg-[#66F1FC] text-black hover:bg-[#66F1FC]"
                        : "hover:bg-gray-100"
                    }`}
                  >
                    {page}
        ...
        <Dialog open={isInfoModalOpen} onOpenChange={setIsInfoModalOpen}>
          <DialogContent className='sm:max-w-md'>
            <DialogHeader>
              <DialogTitle className='text-center text-[#F3F4F6] text-xl font-semibold'>
                Subscriber Info
              </DialogTitle>
            </DialogHeader>
            ...
            {selectedSubscriber && (
              <div className='space-y-4 py-4'>
                <div className='flex justify-between'>
                  <span className='font-medium text-[#F3F4F6]'>SL no:</span>
                  <span className='text-gray-600'>{selectedSubscriber.id}</span>
                </div>

                <div className='flex justify-between'>
                  <span className='font-medium text-[#F3F4F6]'>User Name:</span>
                ...
                <div className='flex justify-between'>
                  <span className='font-medium text-[#F3F4F6]'>End Date:</span>
                  <span className='text-gray-600'>
                ...
                <div className='flex justify-between'>
                  <span className='font-medium text-[#F3F4F6]'>Amount</span>
                  <span className='text-gray-600'>
